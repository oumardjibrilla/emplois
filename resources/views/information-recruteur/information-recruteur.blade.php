             ...
             <div class="card-global-information">
                            <div class="information-image">
                                <div class="divs-label">photo de profil</div>
                                 <div class="valeur-image"><img src="{{ asset('storage/' . $candidat->photo) }}" alt="Photo de profil"  alt="" height="100px"></div>
                            </div>
                            ...
                            <div class="information-text">
                                 <div class="divs-label">nom de l'entreprise :</div>
                                 <div class="valeur">{{$candidat->nomentreprise}}</div>
                            </div>
                            <div class="information-text">
                                <div class="divs-label">fonction :</div>
                                 <div class="valeur">{{$candidat->fonction}}</div>
                            </div>
             </div>

             <div class="div-boutton">
                <a href="#"  class="supprimer-a">Suppression de votre compte</a>
                <a href="{{route('modif-info-recruteur')}}" class="a-modifier"> <i class="fa-solid fa-pen"></i> Modifier mes informations</a>
             </div>
