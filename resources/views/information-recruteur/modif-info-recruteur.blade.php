...
{{-- la partie des information personnelle --}}
   <div class="div-information">
           <form action="{{route('modifier-information-recruteur')}}" class="form1" method="post">
              @csrf
                  ...
                  <div class="divglobale-input">
                        ...
                        <div class="div-input">
                         ...
                         <div class="div-input">
                                ...
                                <input type="text" name="nom-entreprise" id="nom-entreprise" value="{{$candidat->nomentreprise}}" required>
                        </div>
                         <div class="div-input">
           ...
           <form action="{{route('modif-pass-recrteur')}}" method="post" class="form2">
                 @csrf
