...
<div class="flash-message">
  ...
  <header>
                ...
                <nav>
                        ...
                        <a href="{{route('OffreValider-recruteur')}}">Mes Offres</a>
                </nav>
  ...
  <main>
            <section class="section1-lien">
                    <ul>
                            <li><a href="{{route('information-recruteur')}}" class="information"> <i class="fa-solid fa-id-card"></i> Mes Informations</a></li>
                            {{-- <li><a href="{{route('cv_candidat')}}" class="cv"> <i class="fa-solid fa-file-pdf"></i> Mon CV</a></li> --}}
                            <li><a href="{{route('photo-recruteur')}}" class="photo"> <i class="fa-solid fa-images"></i> Ma Photo</a></li>
                            <li><a href="{{route('modif-info-recruteur')}}" class="modifier"> <i class="fa-solid fa-pen"></i> modifier</a></li>
